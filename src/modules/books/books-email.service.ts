...
© ${new Date().getFullYear()} Visualizar. Todos los derechos reservados.
  ...
  /**
   * Send approval email to the teacher who created the book request
   */
  async sendBookRequestApprovedToTeacher(
    teacherEmail: string,
    teacherName: string,
    bookRequestData: {
      id: string;
      ...
      <html>
        ...
        <body>
          <div class="container">
            <div class="header">
              <div class="icon">📚</div>
              <h1>Solicitud de libro aprobada</h1>
            </div>
            
            <div class="content">
              <h2>Gracias, ${teacherName}!</h2>
              <p>Tu solicitud de libro ha sido aprobada y está pendiente de publicación por los administradores.</p>
              ...
              <div class="success-box">
                <strong>✅ Qué sigue?</strong><br/>
                Tu solicitud ahora está lista para publicarse. Serás notificado por correo electrónico una vez que un administrador revise y actualice el estado de tu solicitud.
              </div>
...
Tu solicitud de libro ha sido aprobada y está lista para publicarse.
...
© ${new Date().getFullYear()} Visualizar. Todos los derechos reservados.
    ...
    try {
      await this.emailService.sendEmail({
        to: teacherEmail,
        subject: `✅ Solicitud de libro aprobada: "${bookRequestData.title}"`,
        html,
        text,
      });
  ...
  /**
   * Send rejection email to the teacher who created the book request
   */
  async sendBookRequestRejectedToTeacher(
    teacherEmail: string,
    teacherName: string,
    bookRequestData: {
      id: string;
      ...
      <html>
        <head>
          <style>
            ...
            .error-box {
              background-color: #d4edda;
              border-left: 4px solid #e8535fff;
              padding: 15px;
              margin: 20px 0;
              border-radius: 4px;
              color: #57151aff;
        ...
        <body>
          <div class="container">
            <div class="header">
              <div class="icon">📚</div>
              <h1>Solicitud de libro rechazada</h1>
            </div>
            
            <div class="content">
              <h2>Lo sentimos, ${teacherName}!</h2>
              <p>Tu solicitud de libro ha sido rechazada por los administradores.</p>
